...
export function Landing() {
  ...
  // Usuário logado não deve ver a landing pública (parece deslogado). Clicar no
  // logo, ou abrir o PWA instalado (start_url "/"), cai aqui → manda pro app.
  if (user) return <Navigate to={isAdmin ? '/admin/jogos' : '/dashboard'} replace />

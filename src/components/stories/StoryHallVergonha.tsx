...
export function StoryHallVergonha({ titulo, conteudo, dados }: Props) {
  ...
  return (
    <div className="relative flex h-[540px] w-[400px] flex-col items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-red-950 via-red-900 to-zinc-900 p-6 text-center">
      {/* Decorative noise */}
